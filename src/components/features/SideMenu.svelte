...
{#if isOpen}
	...
	>
		<div class="p-4 border-b border-neutral-300 dark:border-neutral-600 flex items-center gap-3">
			<button
				on:click={closeMenu} class="p-3 rounded-lg hover:bg-neutral-300 dark:hover:bg-neutral-600 focus:outline-none transition-colors duration-200"
				aria-label="메뉴 닫기"
			>
				<svg
					class="w-6 h-6"
